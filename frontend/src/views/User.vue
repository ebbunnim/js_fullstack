...
export default {
  ...
  methods: {
    getReq() {
      axios
        .get("http://localhost:3000/api/user/index.js", {
          user: "getMan"
        })
        .then(r => {
    ...
    postReq() {
      axios
        .post("http://localhost:3000/api/user/index.js", {
          user: "postMan"
        })
        .then(r => {
    ...
    putReq() {
      axios
        .put("http://localhost:3000/api/user/index.js", {
          user: "putMan"
        })
        .then(r => {
    ...
    delReq() {
      axios
        .delete("http://localhost:3000/api/user/index.js")
        .then(r => {
